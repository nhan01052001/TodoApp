...
import { CustomStyleSheet } from '../global/theme/Styles.Theme';
...
export const DataTaskProgressing = [
  ...
  },
  {
    ...
    icon: (
      <IconMaterialIcons name={'emoji-people'} size={18} color={'#007AFF'} />
    ),
      ...
      <ScrollView style={styles.wrapAll}>
        <View style={styles.wrapHeader}>
          <View style={styles.headerLeft}>
            <Image
              ...
              style={CustomStyleSheet.cricle(50)}
            />
        ...
        <View style={styles.noteTaskToDay}>
          <View
            ...
            <View
              ...
              <Text numberOfLines={3} style={styles.txtNoteTaskToday}>
                Bạn có công việc chưa hoàn thành.
              </Text>
            </View>

            <TouchableOpacity
              style={styles.btnViewTask}
              onPress={() => {
                navigation.navigate('ListTask');
              }}>
              <Text style={styles.txtBtnViewTask}>Xem công việc</Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.taskInProgress}>
          <View style={styles.wrapLableTaskInProgress}>
            <Text style={styles.txtLableInProgess}>Đang thực hiện</Text>
          ...
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
            {DataTaskProgressing.map((item, index) => {
              return <TaskProgerssing key={index} item={item} />;
            })}
          </ScrollView>
        </View>
        ...
        <View style={styles.taskInProgress}>
          <View style={styles.wrapLableTaskInProgress}>
            <Text style={styles.txtLableInProgess}>Nhóm công việc</Text>
            <View style={styles.countTaskInProgess}>
              <Text style={styles.numberTaskInProgess}>5</Text>
            </View>
          </View>
          ...
          <ScrollView>
            {DataTaskGroup.map((item, index) => {
              return <GroupTask key={index} item={item} />;
            })}
          </ScrollView>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: Colors.clGray_1,
  },
